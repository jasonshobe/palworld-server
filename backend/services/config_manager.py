...
# Default values used to seed the config page when a key is absent on disk.
# Sourced from the stock palworld-server-docker PalWorldSettings.ini, with the
# identity/credential fields overridden for a fresh server.
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "ServerDescription": "My PalWorld Server",
    "AdminPassword": "",
